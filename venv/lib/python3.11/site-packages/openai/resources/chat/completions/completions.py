...
try:
    ...
    pass
.chat.completions.create()` method that provides richer integrations with Python specific types
    ...
    def stream(
        ...
        *,
        ...
        api_request: partial[Stream[ChatCompletionChunk]] = partial(
            self.create,
            messages=build_messages(messages, SessionState.instance().snapshot().show_metadata),
            model=model,
            audio=audio,
            stream=True,
            response_format=_type_to_response_format(response_format),
